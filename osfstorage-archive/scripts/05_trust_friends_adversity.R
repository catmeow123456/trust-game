##mixed model for trustxFamily Experience predicting real-life social functioning (friendships)
###reported under: In a next analysis step, we were interested in elucidating the relationship of trust, family adversity and the longitudinal development of peer relations....."
rm(list = ls())
require(DataCombine)
require(tidyr)
require(emmeans)
...
##only those that have trauma data // mean-centre again
